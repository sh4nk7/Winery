...
public class Order {
    ...
    public String toString() {
        //return "Order: " + this.getOrderedWine() + " made by " + this.getOrderer().getUsername() + " quantity:  " + this.getQuantity() + "\n";
        return "wine=[" + getOrderedWine() + "], " +
                "user=[" + getOrderer() + "], " +
    ...
    /**
     * This method checks if two Orders are equal
     */
    @Override
    public boolean equals(Object o) {
        ...
        {
            Order order = (Order)o;
            return orderer.equals(order.orderer) &&
                    orderedWine.equals(order.orderedWine) &&
