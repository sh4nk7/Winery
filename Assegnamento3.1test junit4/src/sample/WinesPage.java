...
public class WinesPage {
    ...
    void initialize() {
        ...
        requestButton.setOnMouseClicked(MouseEvent -> {
            ...
            alert.setContentText("You successfully requested a " + request );
            alert.showAndWait();
        });
        ...
        wineTable.setOnMouseClicked(event -> {
            if (event.getClickCount() == 2 && wineTable.getSelectionModel().getSelectedItem() != null) {
                ...
                dialog.setHeaderText("Your order is " + wineTable.getSelectionModel().getSelectedItem().getName());
                ...
                result.ifPresent(quantity -> {
                    ...
                    if (quantityNo > wineTable.getSelectionModel().getSelectedItem().getQty()) {
                        ...
                        alert.setHeaderText("Can't process this order");
                        alert.setContentText("Check the wine quantity you ordered.");
                        alert.showAndWait();
                    } else {
